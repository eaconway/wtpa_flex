...
class NavBar extends React.Component{
    ...
    render() {
        let userOptions = this.props.currentUser.id === undefined ? <div className={`${this.state.userOptions} user-options`}>
              <div onClick={() => this.handleClick("login")} className={"nav-link"}>
                Login
              </div>
              <div onClick={() => this.handleClick("signup")} className={"nav-link"}>
                Signup
              </div>
            </div> : <div className={`${this.state.userOptions} user-options`}>
                <div onClick={() => this.handleClick("logout")} className={"nav-link"}>
                Logout
              </div>
            </div>;
