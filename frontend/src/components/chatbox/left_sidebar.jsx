...
class LeftSidebar extends React.Component {
  ...
  leftSidebarChange(side) {
    if (side === 'create') { //TODO double check sidebar as merge might have made this wrong again
      ...
      let currentSection =
        ...
        <img className='emoji-icon' src={require('../../images/drugs/991884.png')} /> */}
          ...
          <div className='info-middle-bar'>
              <div onClick={() => this.leftSidebarChange("info")} className="info-rectangle"><i className="fas fa-info-circle"></i></div>
              <div onClick={() => this.leftSidebarChange("create")} className="create-rectangle"><i className="fas fa-marker"></i></div>
            </div>
