...
class LeftSidebar extends React.Component {
  ...
  render() {
    if (this.state.loaded && this.props.opinion) {
      ...
      let currentSection = this.state.infoSidebar === "info" ?<div>
        <div className="left-sidebar">
            <div className="left-homepage-sidebar">
              <div className="left-homepage-sidebar-inner">
                ...
                <div className='star-ratings'>
                  {/*<StarRatings
                    rating={this.props.opinion.avgRating ? this.props.opinion.avgRating : 0}
          ...
          <div className='middle-bar'>
              <div className="info-rectangle"><i className="fas fa-info-circle"></i></div>
              <div onClick={() => this.leftSidebarChange("info")} className="create-rectangle"><i className="fas fa-marker"></i></div>
            </div>
          <Link className='close-sidebar' to="/">
            <div className='white-middle-bar-toggle'>
       ...
       <div>
            ...
            <div className="left-create-homepage-sidebar-inner">
              <div className="five-star-section">
                ...
                <div className="form-five-star">
                  ...
                  <i onClick={() => this.rate("two-star")} className={`${this.state.twoStar} fas fa-star`} />
                  <i onClick={() => this.rate("three-star")} className={`${this.state.threeStar} fas fa-star`} />
                  <i onClick={() => this.rate("four-star")} className={`${this.state.fourStar} fas fa-star`} />
                  <i onClick={() => this.rate("five-star")} className={`${this.state.fiveStar} fas fa-star`} />
                </div>
              </div>
        ...
        <div className='middle-bar'>
            <div onClick={() => this.leftSidebarChange("create")} className="info-rect">
              <i className="fas fa-info-circle"></i>
            </div>
            <div className="create-rect"><i className="fas fa-marker"></i></div>
          </div>
        <Link className='close-sidebar' to="/">
          <div className='white-middle-bar-toggle'>
            <i className="fas fa-angle-left"></i>
